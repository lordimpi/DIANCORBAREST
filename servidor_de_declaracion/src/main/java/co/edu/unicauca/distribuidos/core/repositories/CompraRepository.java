...
import co.edu.unicauca.distribuidos.core.controllers.NotificacionesController;
...
public class CompraRepository {
    ...
    public Compra RegistrarCompra(Compra nuevaCompra) {
        ...
        if (ValidarUmbral(nuevaCompra)) {
            NotificacionesController controladorNotificaciones = new NotificacionesController();
            controladorNotificaciones.Notificar(nuevaCompra);
        }
        return nuevaCompra;
    }
